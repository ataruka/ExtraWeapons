...
### Run
 execute as @e[tag=tmp.target] run scoreboard players set @s ExWeapons.Abnormal.voidTick 300
 execute as @e[tag=tmp.target] run tag @s add ExWeapons.Abnormal.voidLv1
