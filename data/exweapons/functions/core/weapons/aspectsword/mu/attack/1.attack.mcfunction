...
### Run
 execute as @e[tag=tmp.target] run function exweapons:core/abnormal/physics/damage_1
 execute as @e[tag=tmp.target] run scoreboard players set @s ExWeapons.Abnormal.physicsTick 190
