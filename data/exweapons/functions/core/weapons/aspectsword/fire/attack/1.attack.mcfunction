...
### Run
 execute as @e[tag=tmp.target] run scoreboard players set @s ExWeapons.Abnormal.fireTick 160
 execute as @e[tag=tmp.target] run tag @s add ExWeapons.Abnormal.fireLv1
