# 旋風処理
 ...
 execute if entity @s[x_rotation=70..90] run summon area_effect_cloud ~ ~0.5 ~ {Radius:0f,Duration:6,DurationOnUse:0f,Age:4,Effects:[{Id:11,Amplifier:4b,Duration:30,ShowParticles:1b}],Tags:["ExWeapons.AEC"]}
 
## 打ち上げ
 execute if entity @s[scores={ExWeapons.ZFacing=-1}] at @s run summon area_effect_cloud ~ ~0.5 ~ {Tags:["ExWeapons.AEC"],Radius:0.0f,Duration:6,DurationOnUse:0,Age:4,Effects:[{Id:25b,Amplifier:3b,Duration:10,ShowParticles:0b},{Id:28b,Amplifier:0b,Duration:20,ShowParticles:0b}]}
