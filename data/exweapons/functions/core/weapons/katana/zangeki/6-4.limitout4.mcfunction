# LimitOut処理
 ...
 execute rotated ~-45 0 positioned ^ ^ ^6 run tag @e[type=!#exweapons:non_living,distance=..5] add ExWeapons.Abnormal.thunderLv1
 execute rotated ~-45 0 positioned ^ ^ ^6 run scoreboard players set @e[type=!#exweapons:non_living,distance=..5] ExWeapons.Abnormal.thunderTick 400
