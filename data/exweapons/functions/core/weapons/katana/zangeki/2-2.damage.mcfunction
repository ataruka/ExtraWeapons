#斬撃のダメージ処理
 ...
 scoreboard players operation $Tep ExWeapons.rng *= $katana_ZangekiDamage ExWeapons.setting
 
 execute store result score $Tmp ExWeapons.rng run data get storage exweapons: weapons.katana.zangeki_damage 0.01
