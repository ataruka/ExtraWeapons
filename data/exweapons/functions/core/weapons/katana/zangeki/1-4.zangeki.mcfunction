#斬撃処理
 ...
 execute as @s at @s positioned ~ ~0.5 ~ run function exweapons:core/weapons/katana/zangeki/4.zangekitp
 ...
 scoreboard players add $Tmp ExWeapons.rng 8
 ...
 execute unless entity @s[nbt={SelectedItem:{tag:{Enchantments:[{}]}}}] unless entity @s[nbt={SelectedItem:{tag:{exweapons:{weapon:{Charged:1}}}}}] run data merge storage exweapons: {item:{weapon:{nbt:{Enchant:true}}}}
 ...
 execute unless entity @s[nbt={SelectedItem:{tag:{Enchantments:[{}]}}}] run item modify entity @s weapon.mainhand exweapons:enchantments/kirakira
