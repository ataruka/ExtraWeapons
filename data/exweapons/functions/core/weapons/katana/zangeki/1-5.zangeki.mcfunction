#斬撃処理
 ...
 execute if entity @s[tag=!tmp.noattack] run summon area_effect_cloud ~ ~0.5 ~ {Radius:0f,Duration:6,DurationOnUse:0f,Age:4,Effects:[{Id:2,Amplifier:5b,Duration:15,ShowParticles:0b}]}
 execute if entity @s[tag=!tmp.noattack] run summon area_effect_cloud ~ ~0.5 ~ {Radius:0f,Duration:6,DurationOnUse:0f,Age:4,Effects:[{Id:11,Amplifier:5b,Duration:50,ShowParticles:1b}]}
