#スラッシュ
## 攻撃
 execute as @s at @s run function exweapons:core/weapons/katana/use/mode1/1-1.tp
 execute as @s at @s run function exweapons:core/weapons/katana/use/mode1/2-1.damage
## 処理
...
### Compound-Nbt
 ...
 data merge storage exweapons: {item:{weapon:{nbt:{ModeAttack:1}}}}
