# 斬撃のダメージ処理
 ...
 scoreboard players operation $Tmp ExWeapons.rng *= $katana_useMultiplier_Mode1_6 ExWeapons.setting
...
### Compound-Nbt
 ...
 execute if entity @s[scores={ExWeapons.katana.useCombo6=18}] run data merge storage exweapons: {item:{weapon:{nbt:{ModeAttack:0,Mode1:{Combo6:1}}}}}
 execute if entity @s[scores={ExWeapons.katana.useCombo6=16}] run data merge storage exweapons: {item:{weapon:{nbt:{ModeAttack:0,Mode1:{Combo6:2}}}}}
 execute if entity @s[scores={ExWeapons.katana.useCombo6=14}] run data merge storage exweapons: {item:{weapon:{nbt:{ModeAttack:0,Mode1:{Combo6:3}}}}}
 execute if entity @s[scores={ExWeapons.katana.useCombo6=12}] run data merge storage exweapons: {item:{weapon:{nbt:{ModeAttack:0,Mode1:{Combo6:4}}}}}
 execute if entity @s[scores={ExWeapons.katana.useCombo6=10}] run data merge storage exweapons: {item:{weapon:{nbt:{ModeAttack:0,Mode1:{Combo6:5}}}}}
 execute if entity @s[scores={ExWeapons.katana.useCombo6=8}] run data merge storage exweapons: {item:{weapon:{nbt:{ModeAttack:0,Mode1:{Combo6:6}}}}}
 execute if entity @s[scores={ExWeapons.katana.useCombo6=6}] run data merge storage exweapons: {item:{weapon:{nbt:{ModeAttack:0,Mode1:{Combo6:7}}}}}
 execute if entity @s[scores={ExWeapons.katana.useCombo6=4}] run data merge storage exweapons: {item:{weapon:{nbt:{ModeAttack:0,Mode1:{Combo6:8}}}}}
 execute if entity @s[scores={ExWeapons.katana.useCombo6=2}] run data merge storage exweapons: {item:{weapon:{nbt:{ModeAttack:0,Mode1:{Combo6:9}}}}}
 execute if entity @s[scores={ExWeapons.katana.useCombo6=0}] run data merge storage exweapons: {item:{weapon:{nbt:{ModeAttack:0,Mode1:{Combo6:10}}}}}
