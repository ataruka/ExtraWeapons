# 斬撃のダメージ処理
 ...
 execute anchored eyes positioned ^ ^-0.5 ^ run function exweapons:core/particle/katana/mode1/2
 ...
 scoreboard players operation $Tmp ExWeapons.rng *= $katana_useMultiplier_Mode1_2 ExWeapons.setting
