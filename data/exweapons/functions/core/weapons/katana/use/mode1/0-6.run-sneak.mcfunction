# スラッシュ
## 攻撃
 execute as @s at @s run function exweapons:core/weapons/katana/use/mode1/1-6.tp-sneak
#^execute as @s at @s run function exweapons:core/weapons/katana/use/mode1/2-6.damage-sneak
## 処理
 scoreboard players add @s ExWeapons.katana.useReturn 40
 scoreboard players set @s ExWeapons.katana.useCombo6sneak 20
...
### Compound-Nbt
 ...
 scoreboard players add $Tmp ExWeapons.rng 5
