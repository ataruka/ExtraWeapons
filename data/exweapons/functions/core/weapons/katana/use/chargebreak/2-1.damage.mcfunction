# 斬撃のダメージ処理
 ...
 execute unless entity @s[scores={ExWeapons.jumpTick=180..200}] anchored eyes positioned ^ ^-0.5 ^ run function exweapons:core/particle/katana/mode1/1
 execute if entity @s[scores={ExWeapons.jumpTick=180..200}] anchored eyes positioned ^ ^-0.5 ^ run function exweapons:core/particle/katana/mode1/1-jump
 ...
 scoreboard players operation $Tmp ExWeapons.rng *= $katana_useMultiplier_Mode1_1 ExWeapons.setting
