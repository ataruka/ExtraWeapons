...
scoreboard players add @s ExWeapons.rnd 2400
data modify storage open: Tmp[].Intelligence_Mul set value 1
execute store result storage open: Tmp[].Intelligence_Mul float 0.1 run scoreboard players get @s ExWeapons.rnd
item modify entity @s weapon.mainhand exweapons:lore_nbt/copy_lore_nbt
data modify storage open: Set.Rng set from storage open: Tmp[].Intelligence_Mul
scoreboard players set #check ExWeapons.rnd -1
# item modify entity @s weapon.mainhand exweapons:lore_nbt/status/intelligence_mul