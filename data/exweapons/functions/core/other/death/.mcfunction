# death処理
execute if score $Damageid ExWeapons.rng matches -2147483648..2147483647 if entity @e[tag=tmp.owner,limit=1,sort=nearest] run damage @s 10000 exweapons:mob_attack by @e[tag=tmp.owner,limit=1,sort=nearest]
execute if score $Damageid ExWeapons.rng matches -2147483648..2147483647 unless entity @e[tag=tmp.owner,limit=1,sort=nearest] run damage @s 10000 exweapons:mob_attack
