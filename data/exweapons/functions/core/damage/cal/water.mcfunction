# ダメージ計算
 ...
 scoreboard players operation $Damagecal ExWeapons.rng += $AttributeDamageCal2 ExWeapons.rng
 scoreboard players operation $Damagecal ExWeapons.rng -= @s ExWeapons.AttributeAbility.WaterProtection
