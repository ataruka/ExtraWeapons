# ダメージ計算
 ...
 scoreboard players operation $Damagecal ExWeapons.rng += $AttributeDamageCal7 ExWeapons.rng
 scoreboard players operation $Damagecal ExWeapons.rng -= @s ExWeapons.AttributeAbility.MuProtection
