# 実行
 ...
 execute unless score $health ExWeapons.rng matches 17.. run tag @s add exweapons.instant_respawn_anchor.failure
 execute unless score $food ExWeapons.rng matches 17.. run tag @s add exweapons.instant_respawn_anchor.failure
