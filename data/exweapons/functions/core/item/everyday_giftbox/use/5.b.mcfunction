...
scoreboard players operation #randomRng ExWeapons.rng += #7 ExWeapons.rng
...
execute if score @s ExWeapons.rnd matches 6 run function exweapons:core/weapons/aspectsword/mu/0.give
