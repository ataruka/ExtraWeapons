 ...
 scoreboard players operation $Damage ExWeapons.rng /= #10 ExWeapons.rng
 execute store result score $Tmp ExWeapons.rng run attribute @s generic.max_health get 100
 scoreboard players operation $Tmp ExWeapons.rng /= #20 ExWeapons.rng
