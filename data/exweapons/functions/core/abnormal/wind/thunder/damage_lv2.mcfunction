 ...
 execute as @e[tag=tmp.target,type=player] at @s run damage @s 2.6 minecraft:lightning_bolt
 execute as @e[tag=tmp.target,type=!player] at @s run damage @s 8 minecraft:lightning_bolt
