 ...
 execute as @e[tag=tmp.target,type=player] at @s run damage @s 4 minecraft:lightning_bolt
 execute as @e[tag=tmp.target,type=!player] at @s run damage @s 12 minecraft:lightning_bolt
