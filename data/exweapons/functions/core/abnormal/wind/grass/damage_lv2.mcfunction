 ...
 execute as @e[tag=tmp.target,type=player] at @s run damage @s 2.6 minecraft:sweet_berry_bush
 execute as @e[tag=tmp.target,type=!player] at @s run damage @s 8 minecraft:sweet_berry_bush
