 ...
 execute as @e[tag=tmp.target,type=player] at @s run damage @s 4 minecraft:sonic_boom
 execute as @e[tag=tmp.target,type=!player] at @s run damage @s 12 minecraft:sonic_boom
