 ...
 execute as @e[tag=tmp.target,type=player] at @s run damage @s 4 minecraft:freeze
 execute as @e[tag=tmp.target,type=!player] at @s run damage @s 12 minecraft:freeze
