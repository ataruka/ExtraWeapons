 ...
 execute as @e[tag=tmp.target,type=player] at @s run damage @s 1 minecraft:drown
 execute as @e[tag=tmp.target,type=!player] at @s run damage @s 3 minecraft:drown
