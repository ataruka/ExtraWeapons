...
execute if entity @s[type=player] run scoreboard players set @s ExWeapons.damagerng 15
...
execute if entity @s[type=!player] run scoreboard players set @s ExWeapons.damagerng 45
 scoreboard players set $Damageid ExWeapons.rng 4
 data modify storage score_damage: Argument.DamageType set value "Fire"
 function exweapons:core/damage/