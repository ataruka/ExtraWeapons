...
execute if entity @s[type=player] run scoreboard players set @s ExWeapons.damagerng 10
...
execute if entity @s[type=!player] run scoreboard players set @s ExWeapons.damagerng 30
 scoreboard players set $Damageid ExWeapons.rng 4
 data modify storage score_damage: Argument.DamageType set value "Fire"
 function exweapons:core/damage/