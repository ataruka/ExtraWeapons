...
#実行
execute as @e[scores={ExWeapons.Abnormal.fireDamageTick=20..},tag=ExWeapons.Abnormal.fireLv1] run function exweapons:core/abnormal/fire/damage_1
execute as @e[scores={ExWeapons.Abnormal.fireDamageTick=20..},tag=ExWeapons.Abnormal.fireLv2] run function exweapons:core/abnormal/fire/damage_2
execute as @e[scores={ExWeapons.Abnormal.fireDamageTick=20..},tag=ExWeapons.Abnormal.fireLv3] run function exweapons:core/abnormal/fire/damage_3
#clear
